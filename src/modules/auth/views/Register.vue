<template>
  ...
  <form class="login100-form validate-form p-b-33 p-t-5" @submit.prevent="onSubmit">
    ...
    <div class="wrap-input100 validate-input" data-validate="Ingrese su nombre de usuario">
      <input v-model="userForm.name" class="input100" type="text" placeholder="Ingrese su nombre de usuario" required>
      <span class="focus-input100" data-placeholder="&#xe82a;"></span>
    </div>

    <div class="wrap-input100 validate-input" data-validate="Ingrese su correo">
      <input v-model="userForm.email" class="input100" type="text" placeholder="Ingrese su correo correo" required>
      <span class="focus-input100" data-placeholder="&#xe818;"></span>
    </div>
